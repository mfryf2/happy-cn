/**
 * AcpDisplay - Ink UI component for ACP-based agents (e.g. CodeBuddy, Codex)
 *
 * Parameterized version of GeminiDisplay with an `agentName` prop
 * so the same component works for all ACP-backed agents.
 */
...
export const AcpDisplay: React.FC<AcpDisplayProps> = ({ messageBuffer, agentName, logPath, currentModel, onExit }) => {
    ...
    useEffect(() => {
        ...
        const unsubscribe = messageBuffer.onUpdate((newMessages) => {
            ...
            // Extract model from [MODEL:...] system messages
